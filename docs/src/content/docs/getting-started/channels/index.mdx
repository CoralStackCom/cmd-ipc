...
<CardGrid>
  ...
  <LinkCard
    title="HTTPChannel"
    description="For HTTP-based communication with REST APIs and edge functions using NDJSON streaming."
    href="/cmd-ipc/getting-started/channels/http-channel/"
  />
  <LinkCard
    title="MCPChannel"
    description="For Model Context Protocol (MCP) integration, exposing commands as AI agent tools."
